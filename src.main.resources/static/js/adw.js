(function() {
	...
	var _setItem = function(pn, pna, pp, ta, ct, ctn, opp, mi, st) {
		items.push([pn, pna, pp, ta, ct, ctn, opp, mi, st]); 
	};
	...
	var _trackTrans = function() {
		...
		if ("view" == _dataType) {
			...
			ourl += '&old_price='+old_price+'&material='+ec(material)+'&pstatus='+pstatus;
		}
